ds_course = [['Deep Learning Specialization by Coursera','https://www.coursera.org/courses?query=machinelearning&productDifficultyLevel=Advanced'],
             ...
             ['Data Science Specialisation','https://www.coursera.org/browse/data-science'],
...
web_course = [['Django Crash course by JustDjango','https://justdjango.com/courses/django-crash-course'],
...
resume_videos = ['https://www.youtube.com/watch?v=3iwCzT2P7vw',
                 'https://youtu.be/CaeUwaaeGpg',
                 'https://www.youtube.com/watch?v=C8J3GpW5oJo']

interview_videos = ['https://youtu.be/b-djHPqLMwQ',
